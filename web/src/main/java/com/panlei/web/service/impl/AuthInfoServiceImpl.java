...
import com.panlei.web.service.AuthInfoService;
import com.panlei.web.service.UserService;
import com.panlei.web.utils.AesCbcUtil;
...
public class AuthInfoServiceImpl implements AuthInfoService {
    ...
    public int insert(AuthInfo pojo){
        return authInfoMapper.insert(pojo);
    }

    public int insertSelective(AuthInfo pojo){
        return authInfoMapper.insertSelective(pojo);
    }

    public int insertList(List<AuthInfo> pojos){
        return authInfoMapper.insertList(pojos);
    }

    public int update(AuthInfo pojo){
        return authInfoMapper.update(pojo);
    }
